...
Most of the source codes of this project, `ccds-example` are stored in the `ccds_example` directory.
...
`make create-container` creates and launch the ccds_example container.
